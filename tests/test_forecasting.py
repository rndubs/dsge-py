...
class TestStateForecast:
    ...
    def test_forecast_states_shape(self, simple_ar1_system):
    ...
    def test_forecast_states_ar1_decay(self, simple_ar1_system):
    ...
    def test_forecast_reproducibility(self, simple_ar1_system):
...
class TestObservableForecast:
    ...
    def test_forecast_observables_shape(self, simple_ar1_system):
    ...
    def test_forecast_observables_matches_states(self, simple_ar1_system):
    ...
    def test_forecast_with_measurement_error(self, simple_ar1_system):
...
class TestUncertaintyBands:
    ...
    def test_compute_forecast_bands_shape(self):
    ...
    def test_forecast_bands_ordering(self):
    ...
    def test_forecast_bands_contain_mean(self):
...
class TestConditionalForecast:
    ...
    def test_conditional_forecast_basic(self, simple_ar1_system):
    ...
    def test_conditional_forecast_shape(self, var_system):
...
class TestForecastIntegration:
    ...
    def test_forecast_with_var_system(self, var_system):
