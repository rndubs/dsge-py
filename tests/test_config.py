...
from dsge.config import Settings, get_fred_api_key, get_settings, reload_settings
...
class TestSettings:
    ...
    def test_settings_has_fred_api_key_field(self) -> None:
        """Test that Settings has fred_api_key field."""
        settings = Settings()
        assert hasattr(settings, "fred_api_key")

    def test_settings_fred_api_key_is_optional(self) -> None:
    ...
    def test_settings_with_env_var(self, monkeypatch) -> None:
    ...
    def test_settings_from_env_file(self, tmp_path, monkeypatch) -> None:
...
class TestGetFredApiKey:
    ...
    def test_get_fred_api_key_returns_string_or_none(self) -> None:
        """Test that get_fred_api_key returns correct type."""
        api_key = get_fred_api_key()
        assert api_key is None or isinstance(api_key, str)

    def test_get_fred_api_key_matches_settings(self) -> None:
    ...
    def test_get_fred_api_key_with_env_var(self, monkeypatch) -> None:
    ...
    def test_get_fred_api_key_without_env_var(self, monkeypatch) -> None:
...
class TestSettingsModel:
    ...
    def test_settings_allows_extra_fields(self, monkeypatch) -> None:
    ...
    def test_settings_field_aliases(self, monkeypatch) -> None:
...
class TestEnvFileTemplate:
    ...
    def test_env_template_has_fred_api_key(self) -> None:
    ...
    def test_env_template_has_instructions(self) -> None:
