...
class TestFrequencyConversion:
    ...
    def test_monthly_to_quarterly_mean(self, sample_monthly_series) -> None:
    ...
    def test_monthly_to_quarterly_last(self, sample_monthly_series) -> None:
    ...
    def test_invalid_aggregation_method(self, sample_monthly_series) -> None:
...
class TestGrowthRates:
    ...
    def test_compute_growth_rate_basic(self, sample_quarterly_series) -> None:
    ...
    def test_compute_growth_rate_annualized(self, sample_quarterly_series) -> None:
        ...
        np.testing.assert_array_almost_equal(
            growth.dropna().values, (growth_q.dropna() * 4).values, decimal=5
        )

    def test_constant_series_zero_growth(self) -> None:
        ...
        np.testing.assert_array_almost_equal(growth.dropna().values, np.zeros(4), decimal=10)


class TestInflationRate:
    """Tests for inflation rate calculations."""

    def test_compute_inflation_rate(self, sample_price_index) -> None:
    ...
    def test_inflation_rate_is_growth_rate(self, sample_price_index) -> None:
        """Test that inflation rate equals growth rate for price index."""
        inflation = compute_inflation_rate(sample_price_index, annualize=True)
        growth = compute_growth_rate(sample_price_index, annualize=True)

        np.testing.assert_array_almost_equal(
            inflation.dropna().values, growth.dropna().values, decimal=10
        )
...
class TestRealSeries:
    ...
    def test_compute_real_series(self) -> None:
...
class TestTransformations:
    ...
    def test_quarterly_growth_rate_transformation(self, sample_quarterly_series) -> None:
    ...
    def test_real_quarterly_growth_rate_transformation(self) -> None:
        ...
        result = transform_series(nominal, "real_quarterly_growth_rate", deflator=deflator)
    ...
    def test_quarterly_inflation_rate_transformation(self, sample_price_index) -> None:
    ...
    def test_log_level_transformation(self, sample_quarterly_series) -> None:
    ...
    def test_level_transformation(self, sample_quarterly_series) -> None:
    ...
    def test_quarterly_average_on_monthly(self, sample_monthly_series) -> None:
    ...
    def test_quarterly_average_on_quarterly(self, sample_quarterly_series) -> None:
    ...
    def test_unknown_transformation_raises_error(self, sample_quarterly_series) -> None:
...
class TestDataValidation:
    ...
    def test_validate_data_with_missing(self) -> None:
    ...
    def test_validate_data_with_inf(self) -> None:
    ...
    def test_validate_data_statistics(self) -> None:
        ...
        np.testing.assert_almost_equal(
            results["std"]["var1"], np.std([1, 2, 3, 4, 5], ddof=1), decimal=5
        )
...
class TestSeriesMapping:
    ...
    def test_all_observables_have_mapping(self) -> None:
    ...
    def test_series_spec_has_required_fields(self) -> None:
        ...
        for obs_name, spec in FRED_SERIES_MAP.items():
            ...
            assert isinstance(spec.fred_code, str)
            assert len(spec.fred_code) > 0

    def test_transformations_are_valid(self) -> None:
