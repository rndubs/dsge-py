...
from dsge.estimation.occbin_estimation import (
    OccBinSMCSampler, estimate_occbin, OccBinSMCResults
)
...
def test_log_likelihood_occbin():
    ...
    log_lik = log_likelihood_occbin(
        model_M1, model_M2, constraint, data,
        max_iter=20
    )
...
def test_log_likelihood_occbin_unstable_params():
    ...
    log_lik = log_likelihood_occbin(
        model_M1, model_M2, constraint, data, params,
        max_iter=20
    )
...
def test_occbin_smc_sampler_initialization():
...
def test_occbin_estimation_basic():
...
def test_occbin_estimation_parameter_recovery():
...
def test_occbin_estimation_convergence():
...
def test_occbin_estimation_with_no_regime_switch():
...
def test_estimate_occbin_function():
